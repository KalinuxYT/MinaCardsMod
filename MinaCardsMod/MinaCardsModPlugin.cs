...
{
  [BepInPlugin("com.KalinuxYT.MinaCardsMod", "MinaCardsMod", "1.0.3")]
  public class MinaCardsModPlugin : BaseUnityPlugin
  {
    ...
    public static string DisableSwappingBaseCardBacksKey = "Disable swapping the backs of the base cards";
    ...
    public static ConfigEntry<bool> DisableSwappingBaseCardBacks;
    ...
    private void Awake()
    {
      ...
      MinaCardsModPlugin.DisableSwappingBaseCardBacks = this.Config.Bind<bool>("General", MinaCardsModPlugin.DisableSwappingBaseCardBacksKey, false, new ConfigDescription("Disable swapping the backs of the base cards.", (AcceptableValueBase) null, Array.Empty<object>()));
      ...
      MinaCardsModPlugin.DisableSwappingBaseCardBacks.SettingChanged += new EventHandler(this.ConfigSettingChanged);
      this.Logger.LogInfo((object) "PluginName: MinaCardsMod, VersionString: 1.0.4 is loading...");
      MinaCardsModPlugin.Harmony.PatchAll();
      this.Logger.LogInfo((object) "PluginName: MinaCardsMod, VersionString: 1.0.4 is loaded.");
